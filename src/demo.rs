...
//! most of the usage cases for `covers` macro.
//! Worth to read it.
//!
//! Source
//! ======
...
//! // Remaining...
//!
//! #[covers(so_then_github_please_behold)]
//! fn i_wasnt_looking_for_this() -> String {
//!     "I wasn't looking for this".to_string()
//! }
//!
//! #[covers(there_is_my_brand_new_crate)]
